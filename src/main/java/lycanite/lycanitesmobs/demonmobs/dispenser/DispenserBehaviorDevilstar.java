...
public class DispenserBehaviorDevilstar extends DispenserBehaviorBase {
    ...
    protected void playDispenseSound(IBlockSource par1IBlockSource) {
        //par1IBlockSource.getWorld().playSoundEffect(par1IBlockSource.getX(), par1IBlockSource.getY(), par1IBlockSource.getZ(), AssetManager.getSound("Devilstar"), 1.0F, 1.0F / (new org.bogdang.modifications.random.XSTR().nextFloat() * 0.4F + 0.8F));
    }
}