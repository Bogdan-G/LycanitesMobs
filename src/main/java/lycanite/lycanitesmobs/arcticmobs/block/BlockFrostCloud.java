...
public class BlockFrostCloud extends BlockBase {
	...
	public BlockFrostCloud() {
		...
		// Stats:
		this.tickRate = ConfigBase.getConfig(this.group, "general").getBool("Features", "Enable Frostclouds", true) ? 200 : 20;
    ...
    public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		...
		if(entity instanceof EntityLivingBase) {
			...
			((EntityLivingBase)entity).addPotionEffect(new PotionEffect(Potion.hunger.id, 2 * 20, 0));
		}
	}
